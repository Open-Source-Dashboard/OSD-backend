    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_commit_repo_name', models.CharField(blank=True, max_length=255, null=True)),
                ('groups', models.ManyToManyField(blank=True, related_name='osd_user_profiles', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='osd_user_profile_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
